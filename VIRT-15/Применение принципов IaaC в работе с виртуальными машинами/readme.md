...
Написан на питоне, комьюнити, документация. 
Агенты не нужны - доступ по ssh достаточен.
Используется метод push (морально ближе)
...
Перепробовав убунту старше 12-ой.. внезапно мы сталкиваемся с проблемой по установке докера.. и снова узнаем о том, что  This Linux distribution (debian stretch) reached end-of-life and is no longer supported by this script.
...
И немедленно прийти к мысли, что нужна какая-то более стабильная среда для тестирования ansible. А связка с вагрантом неплохая, но сильно зависит от типа используемых виртуальных машин. Т.е. универсальности не наблюдается.
